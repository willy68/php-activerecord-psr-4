...
class AdapterTest extends DatabaseTest
{
	...
	public function test_no_host_connection()
	{
		...
		$this->expectedException("\ActiveRecord\Exceptions\DatabaseException");
	}
	...
	public function test_date_time_type()
	{
		...
		$this->assert_equals(\ActiveRecord\Column::DATETIME, $columns['created_at']->type);
	...
	public function test_date()
	{
		...
		$this->assert_equals(\ActiveRecord\Column::DATE, $columns['some_Date']->type);
	...
	public function test_columns_type()
	{
		...
		$this->assert_equals(\ActiveRecord\Column::STRING, $author_columns['name']->type);
	...
	public function test_columns_time()
	{
		...
		$this->assert_equals(\ActiveRecord\Column::TIME, $author_columns['some_time']->type);
	}
	...
	public function test_columnsx()
	{
		...
		$this->assert_equals(\ActiveRecord\Column::INTEGER, $columns['author_id']->type);
		...
		$this->assert_equals(\ActiveRecord\Column::STRING, $columns['name']->type);
	...
	public function test_columns_decimal()
	{
		...
		$this->assert_equals(\ActiveRecord\Column::DECIMAL, $columns['special']->type);
