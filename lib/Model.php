...
class Model
{
     ...
     * (see {@link Serialization} for valid options)
     ...
     *
     * @see Serialization
     * @param array $options An array containing options for csv serialization
     * (see {@link Serialization} for valid options)
     ...
     * To cause a rollback have your closure return false or throw an exception.
