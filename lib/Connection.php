...
abstract class Connection
{
     ...
     *
     * @param string $connection_string_or_connection_name A database connection
     * string (ex. mysql://user:pass@host[:port]/dbname)
    ...
    public static function instance($connection_string_or_connection_name = null)
    {
        ...
        if (
            empty($connection_string_or_connection_name) ||
